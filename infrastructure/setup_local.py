...
if any(p.exists() for p in paths):
    raise SystemExit(
        "Configuration already exists. Preserve its database passwords; edit explicitly."
    )
...
for p in paths:
    p.chmod(0o600)
print(
    "Created infrastructure/.env, backend/.env and backend/.env.test. Keep them out of Git."
)
